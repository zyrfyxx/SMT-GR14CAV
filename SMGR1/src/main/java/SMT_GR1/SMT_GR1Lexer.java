...
public class SMT_GR1Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "TYPE", "KIND", "INT", "FLOAT", "PLUS", 
			"MINUS", "MUL", "DIV", "SQUARE", "LT", "GT", "LTE", "GTE", "EQ", "NEQ", 
			"AND", "OR", "IMPL", "EQUIV", "NOT", "NEXT", "TRUE", "FALSE", "LPAREN", 
			"RPAREN", "NAME", "ID", "WS"
		};
	}
	...
	public SMT_GR1Lexer(CharStream input) {
		super(input);
